...
fun SelectionDialogPreview() {
    SelectionDialog(
        ...
        onConfirmation = {},
        title = "Тип",
        variants = setOf(DogType.HOUND, DogType.TOY),
        selectedVariants = setOf(DogType.HOUND),
...
fun SelectionDialog(
    ...
    onConfirmation: () -> Unit,
    title: String,
    variants: Set<DogType>,
    selectedVariants: Set<DogType>,
    onVariantSelectedChanged: (DogType, Boolean) -> Unit
) {
